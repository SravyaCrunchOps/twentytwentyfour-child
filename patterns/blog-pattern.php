...
<div class="wp-block-group"><!-- wp:group {"tagName":"main","align":"wide","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained","wideSize":"100%"}} -->
<main class="wp-block-group alignwide"><!-- wp:post-title {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"3.5rem","fontStyle":"normal","fontWeight":"700"}},"fontFamily":"body"} /-->
...
<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--20)">
...
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--20);padding-top:0"><!-- wp:post-title {"textAlign":"left","level":5,"isLink":true,"style":{"layout":{"flexSize":null,"selfStretch":"fit"},"typography":{"fontStyle":"normal","fontWeight":"700","textTransform":"capitalize","textDecoration":"none","letterSpacing":"1px"},"elements":{"link":{":hover":{"color":{"text":"#131e9c"}}}}},"fontFamily":"body"} /-->

<!-- wp:template-part {"slug":"post-meta","theme":"twentytwentyfour-child"} /--></div>
<!-- /wp:group -->
